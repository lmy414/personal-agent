  ...
  return (
    <div class="glass-panel-full" style={{ display: 'flex' }}>
      ...
      <div style={{ width: '360px', 'flex-shrink': '0', display: 'flex', 'flex-direction': 'column', 'border-right': '1px solid rgba(255,255,255,0.06)' }}>
        <div style={{ display: 'flex', 'align-items': 'center', 'justify-content': 'space-between', padding: '12px 16px', height: '54px', 'font-family': '"Noto Serif SC", serif', 'font-size': '15px', 'font-weight': '600', background: 'rgb(var(--top-bar-tint-rgb))', 'border-bottom': '1px solid rgba(255,255,255,0.03)', 'flex-shrink': '0' }}>
          <span>记录</span>
